...
System.register("chunks:///_virtual/EnumDefine.ts", ['cc'], function () {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "a06075vH0ZO2KAE5qtttTtF", "EnumDefine", undefined);
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './EnumDefine.ts', './Main.ts'], function () {
  'use strict';
...
System.register("chunks:///_virtual/Main.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  var _applyDecoratedDescriptor, _inheritsLoose, _extends, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, WebView, Label, Button, Node, Component;
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var Main = exports('Main', (_dec = ccclass('Main'), _dec2 = property(WebView), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function Main() {
          ...
          _initializerDefineProperty(_this, "indiciator", _descriptor6, _assertThisInitialized(_this));

          _this.loginBase64 = '';
          _this.usrProfile = null;
          return _this;
        }
        ...
        _proto.onRecievedMsg = function onRecievedMsg(ev) {
          console.log("[onRecievedMsg]" + _extends({}, ev));
          this.wb.node.active = false;
            ...
            case "sign_in_success":
              {
                ...
                this.signinButton.node.active = false; //this.signMessageButton.node.active = true;
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "indiciator", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
